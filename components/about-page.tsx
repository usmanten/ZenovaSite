...
export default function AboutPage() {
    ...
    return (
        <div className="overflow-hidden bg-white text-black">
            ...
            <section
                ref={heroRef}
                className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-blush-300 px-6 pb-20 pt-28 text-center"
            >
                {/* Subtle grid */}
                <div
                    aria-hidden
                ...
                <div
                    aria-hidden
                    className="hero-bg-text pointer-events-none absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 select-none font-black leading-none text-black/[0.05]"
                ...
                <div
                    aria-hidden
                    className="pointer-events-none absolute left-1/2 top-1/2 size-[700px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-white/50 blur-[130px]"
                />
                ...
                <div className="hero-content relative z-10">
                    ...
                    >
                        <p className="text-[10px] font-bold uppercase tracking-[0.4em] text-black">Our Story</p>

                        <h1
                            className="max-w-4xl font-black leading-[1.05] text-black"
                            style={{ fontSize: "clamp(3rem, 8vw, 7rem)" }}
                        >
                            <span className="text-black">We believe supplements</span>
                            <br />
                            <span className="text-black/40">should actually work.</span>
                        </h1>

                        <p className="max-w-2xl text-balance text-lg text-black">
                        ...
                        <div className="mt-2 h-px w-24 bg-gradient-to-r from-transparent via-black/15 to-transparent" />
                    </AnimatedGroup>
                </div>
            </section>

            {/* ── STATS ────────────────────────────────────────────────────────── */}
            <section className="border-y border-blush-100 bg-white py-24">
                <div className="mx-auto max-w-6xl px-6">
                    ...
                    <div className="grid grid-cols-1 gap-px bg-blush-100 md:grid-cols-3">
                        {stats.map((stat) => (
                            <div
                                key={stat.label}
                                className="stat-card flex flex-col items-center gap-2 bg-white px-6 py-12 text-center"
                            >
                                <span className="text-5xl font-black tabular-nums text-black md:text-6xl">
            ...
            <section
                ref={quoteRef}
                className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-blush-100 px-8 text-center text-black"
            >
                <div className="relative z-10 mx-auto max-w-4xl">
                    <blockquote className="text-balance text-3xl font-medium leading-snug text-black md:text-4xl lg:text-[2.8rem]">
                    ...
                    <div className="quote-divider mx-auto mt-10 h-px w-16 bg-blush-950/20" />

                    <p className="quote-author mt-6 text-sm text-blush-900">
            ...
            {/* ── WHAT WE STAND FOR ─────────────────────────────────────────────── */}
            <section ref={timelineRef} className="bg-white py-24 md:py-36">
                <div className="mx-auto max-w-6xl px-6">
                    <div className="mb-20 text-center">
                        <span className="mb-4 inline-block text-[10px] font-bold uppercase tracking-[0.4em] text-black">
                            Our principles
                        </span>
                        <h2
                        ...
                        >
                            What we <span className="text-blush-700">stand for</span>
                        </h2>
                    </div>
                    ...
                    <div className="relative mx-auto max-w-3xl">
                        {/* Static spine */}
                        <div
                            className="absolute bottom-0 left-1/2 top-0 w-px -translate-x-1/2 bg-blush-200"
                            aria-hidden
                        />
                        {/* Scroll-driven fill */}
                        <motion.div
                            ref={progressBarRef}
                            className="absolute left-1/2 top-0 w-px -translate-x-1/2 origin-top bg-blush-700"
                        ...
                        <div className="flex flex-col gap-16">
                            {values.map((v, i) => (
                                ...
                                >
                                    ...
                                    >
                                        <div
                                            className={`mb-2 inline-flex size-9 items-center justify-center rounded-xl border border-blush-200 bg-blush-100 text-blush-700 transition-all duration-300 hover:border-blush-300 hover:bg-blush-200 hover:text-blush-900 ${
                                                i % 2 === 0 ? "ml-auto flex" : ""
                                            }`}
                                        >
                                            {v.icon}
                                        </div>
                                        <h3 className="mt-1 text-lg font-bold text-black">{v.title}</h3>
                                    ...
                                    <div className="absolute left-1/2 top-2 -translate-x-1/2">
                                        <div className="milestone-dot size-3 rounded-full border-2 border-blush-400 bg-white" />
                                    </div>
            ...
            <section className="relative flex min-h-[65vh] flex-col items-center justify-center overflow-hidden border-t border-blush-100 bg-blush-300 px-6 text-center">
                ...
                <div
                    aria-hidden
                    className="pointer-events-none absolute left-1/4 top-1/2 size-[500px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-white/40 blur-3xl"
                />
                <div
                    aria-hidden
