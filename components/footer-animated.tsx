    ...
    <footer ref={footerRef} className="border-t border-white/5 bg-black py-16 md:py-28">
      <div className="mx-auto max-w-5xl px-6">
        ...
        <div ref={socialRef} className="my-8 flex flex-wrap justify-center gap-6 text-sm">
          <Link href="https://www.instagram.com/zenovastrips/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-white/50 hover:text-white/85 block transition-colors duration-150">
          ...
          <div className="relative">
            <button
              ...
              aria-label="Amazon"
              className="text-white/50 hover:text-white/85 block transition-colors duration-150"
            >
              <svg className="size-6" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
            ...
            {amazonToast && (
              <span className="absolute -top-8 left-1/2 -translate-x-1/2 whitespace-nowrap rounded-md bg-white/10 px-2.5 py-1 text-[10px] font-medium text-white/85">
                Coming soon!
              </span>
            )}
          </div>
          <Link href="https://www.tiktok.com/@zenova.strips" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="text-white/50 hover:text-white/85 block transition-colors duration-150">
            <svg className="size-6" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
          ...
          <Link href="https://x.com/zenovastrips" target="_blank" rel="noopener noreferrer" aria-label="X" className="text-white/50 hover:text-white/85 block transition-colors duration-150">
            <svg className="size-6" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
        ...
        <span ref={copyrightRef} className="block text-center text-xs font-medium tracking-widest text-white/40">
        ...
        <div ref={legalRef} className="mt-4 flex justify-center gap-6">
          <Link
            href="/legal/tos"
            className="text-xs text-white/40 hover:text-white/70 transition-colors duration-150 tracking-wide"
          >
            Terms of Service
          </Link>
          <Link
