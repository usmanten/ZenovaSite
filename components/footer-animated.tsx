    ...
    <footer ref={footerRef} className="border-t border-blush-950/10 bg-white py-16 md:py-28">
      <div className="mx-auto max-w-5xl px-6">
        ...
        <div ref={socialRef} className="my-8 flex flex-wrap justify-center gap-6 text-sm">
          <Link href="https://www.instagram.com/zenovastrips/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-blush-950 hover:text-blush-950/70 block transition-colors duration-150">
          ...
          <Link href="https://www.amazon.com/s?k=Zenova+strips&ref=bl_dp_s_web_0" target="_blank" rel="noopener noreferrer" aria-label="Amazon" className="text-blush-950 hover:text-blush-950/70 block transition-colors duration-150">
            <svg className="size-6" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
          ...
          <Link href="https://www.tiktok.com/@zenova.strips" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="text-blush-950 hover:text-blush-950/70 block transition-colors duration-150">
            <svg className="size-6" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
          ...
          <Link href="https://x.com/zenovastrips" target="_blank" rel="noopener noreferrer" aria-label="X" className="text-blush-950 hover:text-blush-950/70 block transition-colors duration-150">
            <svg className="size-6" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
        ...
        <span ref={copyrightRef} className="block text-center text-xs font-medium tracking-widest text-blush-950">
        ...
        <div ref={legalRef} className="mt-4 flex justify-center gap-6">
          <Link
            href="/legal/tos"
            className="text-xs text-blush-950 hover:text-blush-950/60 transition-colors duration-150 tracking-wide"
          >
            Terms of Service
          </Link>
          <Link
