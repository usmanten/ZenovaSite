        ...
        <footer ref={footerRef} className="border-t border-white/5 bg-black py-16 md:py-28">
            <div className="mx-auto max-w-5xl px-6">
                ...
                <div ref={socialRef} className="my-8 flex flex-wrap justify-center gap-6 text-sm">
                    <Link href="#" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-white/30 hover:text-white/70 block transition-colors duration-150">
                    ...
                    <Link href="#" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="text-white/30 hover:text-white/70 block transition-colors duration-150">
                        <svg className="size-6" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
