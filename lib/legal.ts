...
For more details, please review our full [Refund Policy](refund).
...
Zenova MM offers a limited risk-free purchase policy for first-time customers.

Customers may try up to three (3) strips from a purchased box. If the customer is not satisfied with the product, they may request a refund provided that:

No more than three (3) strips were used from the box;

The customer contacts Zenova MM within 30 days of delivery to request the refund;

The remaining product is returned to Zenova MM; and

The customer provides proof of purchase.

Returned products must include the original packaging and the remaining unused strips.
...
Zenova MM reserves the right to deny refund requests that appear fraudulent, abusive, excessive, or inconsistent with this policy.

Refunds will be issued to the original payment method after the returned product is received and inspected.`
